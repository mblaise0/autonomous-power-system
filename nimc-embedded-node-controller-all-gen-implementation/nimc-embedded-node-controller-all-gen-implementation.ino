...
const char* username = "Node-Controller"; // my AskSensors username

const char* mqtt_server = "192.168.2.44";
unsigned int mqtt_port = 11883;
...
//Utility Tasks
Task engageGen01Contactors(3000, TASK_FOREVER, &instructionToEngageGen01Contactors);
Task engageGen02Contactors(3000, TASK_FOREVER, &instructionToEngageGen02Contactors);
Task engageGen03Contactors(3000, TASK_FOREVER, &instructionToEngageGen03Contactors);
...
Task connectPowerToDistributionAndStabilizer(5000, TASK_FOREVER, &instructionToConnectPowerToDistributionAndStabilizer);

//Auxillaries report
Task initiateClosingOfUtilityOrGenContator(3000, TASK_FOREVER, &interlockUtilityBreakerClosedSuccessReport);
Task powerConnectorToUtilityToStabBreaker(3000, TASK_FOREVER, &instructionToConnectPowerTUtilityToStabBreaker);
...
Task startGen01(3000, TASK_FOREVER, &startGenerator01Routine);
Task startGen02(3000, TASK_FOREVER, &startGenerator02Routine);
Task startGen03(3000, TASK_FOREVER, &startGenerator03Routine);

Task startGen335kvaGenerator(3000, TASK_FOREVER, &startGen335kvaGeneratorRoutine);

Task stopGenerator01(3000, TASK_FOREVER, &stopGenerator01Routine);
Task stopGenerator02(3000, TASK_FOREVER, &stopGenerator02Routine);
Task stopGenerator03(3000, TASK_FOREVER, &stopGenerator03Routine);

Task stop335kvaGenerator(3000, TASK_FOREVER, &stop335kvaGeneratorRoutine);
...
void setup() {
  ...
  // GMT -1 = -3600
  // GMT 0 = 0
  timeClient.setTimeOffset(3600); // 0= GMT, 3600 = GMT+1
   ...
   */
     ...
     */
     ...
     if(utilityNotGoodFlagCount == utilityNotGoodWaitingInterval){
       ...
       * as well as start process to start to bring on gen power 
       */
       Serial.println("************************Generator has been turned on, Power available***************************");
   ...
   engage335Contactor.enableDelayed(2000);
    ...
    utilityNotGoodFlagCount = Value.toInt(); 
  }
}
